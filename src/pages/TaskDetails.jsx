...
const TaskDetails = () => {
    ...
    useEffect(() => { fetchTaskDetails(); }, [taskId]); // eslint-disable-line react-hooks/exhaustive-deps
    ...
    }, [taskId, task]); // eslint-disable-line react-hooks/exhaustive-deps
                        ...
                        {comments.length > 0 ? (
                            <div className="flex flex-col gap-4 mb-6 mr-2">
                                {comments.map((comment) => (
                                    <div key={comment.id} className={`sm:max-w-4/5 dark:bg-gradient-to-br dark:from-zinc-800 dark:to-zinc-900 border border-gray-300 dark:border-zinc-700 p-3 rounded-md ${comment.user_id === user?.id ? "ml-auto" : "mr-auto"}`} >
                ...
                <div className="p-5 rounded-md bg-white dark:bg-zinc-900 border border-gray-300 dark:border-zinc-800 ">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-700 dark:text-zinc-300">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            Due : {task.due_date ? format(new Date(task.due_date), "dd MMM yyyy") : "Not set"}
                        </div>
                    </div>
                </div>
